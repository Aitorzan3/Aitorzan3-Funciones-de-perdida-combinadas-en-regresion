...
# Definición de una función de puntuación para los modelos con múltiples salidas basados en el error absoluto medio
...
if __name__ == '__main__':
    ...
    print("Companion Loss mse - CE K=28")
    print("l2 = " + str(l2) + "\n lw " + str(lw) + "\n" + "score = " + str(score))
    
    # Guardado del modelo óptimo arrojado por la búsqueda exhaustiva para el posterior análisis de resultados
    dump(cv_estimator_0, 'comp_wrap_K28.joblib')
