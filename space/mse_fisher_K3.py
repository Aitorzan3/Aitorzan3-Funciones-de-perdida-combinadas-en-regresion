...
def network(l2, lw):
    ...
    clas_layer = Dense(3, activation="linear", kernel_initializer = 'glorot_uniform', kernel_regularizer=regularizers.l2(l2), name = 'clas_layer')(layer_1)
...
# Definición de una función para cargar los datos del problema space
def space_data():
