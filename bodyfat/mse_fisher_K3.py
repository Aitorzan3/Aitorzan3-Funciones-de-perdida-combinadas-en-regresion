...
if __name__ == '__main__':
    ...
    q = np.quantile(y,[0,1/3,2/3,1])
    y_clas = np.array(pd.cut(x=y.reshape(-1,), bins=q, labels=[0, 1,2], include_lowest=True, right=True))
    ...
    print("Companion Loss mse - Fisher K=3")
    print("l2 = " + str(l2) + "\n lw " + str(lw) + "\n" + "score = " + str(score))

    # Guardado del modelo óptimo para el posterior análisis de resultados
    dump(cv_estimator_0, 'comp_wrap2_K3.joblib')
